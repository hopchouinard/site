...
Attempt 1 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      date: 'Tue, 11 Nov 2025 12:01:42 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=13819',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '778235282fa47956',
...
Here's a list of emerging startups and open-source communities developing notable AI applications, particularly agentic frameworks:

**Startups:**

*   **Diagrid**: Associated with **Dapr Agents**, an early-stage open-source project extending Dapr Workflow for AI agent communication.
*   **Solo.io**: Leads the development of **Kagent**, a new open-source AI agent framework.
*   **Gatsby Team**: Created **Mastra**, a JavaScript framework for frontend developers to build agents.
*   **PydanticAI** and **Atomic Agents**: Focus on structured, controlled AI agents.

**Other Open-Source Agentic AI Frameworks (some with startup involvement, others community-driven):**

*   **Microsoft AutoGen**: For autonomous AI systems with emphasis on security, compliance, and LLM orchestration.
*   **LangChain**: A composable framework for building complex AI workflows.
*   **CrewAI**: A collaborative AI framework for team-based AI development.
*   **AutoGPT**: A pioneer in autonomous AI agents for self-sustaining AI systems.
*   **AgentGPT**: Browser-based interface for deploying Auto-GPT-style agents.
*   **MetaGPT**: Simulates a software development team for automated workflows.
*   **Camel-AI (CAMEL)**: Used for role-playing multi-agent simulations.
*   **BabyAGI**: Focuses on autonomous task management.
*   **SuperAGI**: A production-ready framework with extensibility and a graphical interface.
*   **LangGraph**: An open-source framework for orchestrating agents.
*   **Open Agents** (formerly OpenDevin).
